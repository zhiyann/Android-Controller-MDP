 ...
 */
public class screenSelectDeviceList extends AppCompatActivity {

    private static final String TAG = "screenSelectDeviceList";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Setup the window
        setContentView(R.layout.activity_screen_select_device_list);
        ...
        Button discoverButton = (Button)findViewById(R.id.button_discovery);
        ...
        if (pairedDevices.size() > 0) {
            ...
            findViewById(R.id.title_paired_devices).setVisibility(View.VISIBLE);
            findViewById(R.id.information_paired_devices).setVisibility(View.VISIBLE);
        }
    }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_FOUND.equals(action)) {
                ...
                if (mNewDevicesArrayAdapter.getCount() == 0) {
                    findViewById(R.id.information_new_devices).setVisibility(View.VISIBLE);
                }
            }
        }
    };
